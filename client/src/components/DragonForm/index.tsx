...
import { ViewBox, Text, Input, Button, SVG, Loading } from '../'
...
export const DragonForm: React.FC<DragonFormProps> = ({ queryLoading, mutationLoading, type, dragon, onSubmit: onSubmitCB }) => {
      ...
      {queryLoading ? (
        ...
        <div className={cn(shared.container, s.container)}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className={shared.form}>
            ...
            <Button loading={mutationLoading} type="submit" className={shared.mbMedium}>
